...
Component error function has useful properties, but also could yield decloning
seemingly far from intuitively optimal.
In the proof of theorem \ref{ultimate-theorem} we 
% ...

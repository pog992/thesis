...
contain more complete and more formal description of the topic. %TODO: fix ref
...
Its proof can be found in \cite{computersandintractability}.
...
Again, its proof in included in \cite{computersandintractability}.
